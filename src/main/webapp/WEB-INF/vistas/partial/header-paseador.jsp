  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="${contextPath}/paseador/paseos/pendientes">Pendientes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="${contextPath}/paseador/paseos/activos">Activos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="${contextPath}/paseador/paseos/finalizados">Historial</a>
        </li>
      </ul>
      <!-- Left links -->
    </div>
